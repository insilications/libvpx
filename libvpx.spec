...
%prep
%setup -q -n libvpx-1.8.1
%patch1 -p1
pushd ..
cp -a libvpx-1.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570572458
...
/usr/lib64/haswell/libvpx.so.6.1
/usr/lib64/haswell/libvpx.so.6.1.0
/usr/lib64/libvpx.so.6
/usr/lib64/libvpx.so.6.1
/usr/lib64/libvpx.so.6.1.0
